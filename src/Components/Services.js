...
<section class="bg-[#F3F4F6] p-5 pt-20 pb-10 lg:pt-[120px] lg:pb-20">
      ...
      <div class="w-full px-4 md:w-1/2 xl:w-1/3">
        <div class="mb-10 overflow-hidden rounded-lg bg-white">
          ...
          <div class="p-8 text-center sm:p-9 md:p-7 xl:p-9">
            ...
            <a 
              href="/" 
              class="hover:bg-teal-600 inline-block rounded-full border border-[#E5E7EB] py-2 px-7 text-base font-medium transition hover:text-white">
              View Details
            </a>
          </div>
        </div>
